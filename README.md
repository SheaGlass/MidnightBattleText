...
[![CurseForge](https://img.shields.io/badge/CurseForge-MidnightBattleText-orange)](https://www.curseforge.com/wow/addons/midnightbattletext)
[![GitHub Release](https://img.shields.io/github/v/release/SheaGlass/MidnightBattleText)](https://github.com/SheaGlass/MidnightBattleText/releases/latest)
...
- **Visual Mode** — drag handles to reposition anchor, incoming, outgoing, and icon
- Filter toggles for every event type including "Only My Damage/Heals"
- Test button, reset to defaults, and profile management
...
### Profile System
Save your entire configuration as a named profile and switch between them.
- `/mbt profile save <name>`
- `/mbt profile load <name>`
- `/mbt profile delete <name>`
- `/mbt profile list`

### Blizzard FCT Suppression
Automatically disables Blizzard's default floating combat text. Toggle with `/mbt blizzfct`.

### Secret Values Compatible
All combat value handling is wrapped in pcall for full compatibility with WoW Midnight's Secret Values API.
...
| `/mbt threshold <n>` | Hide hits below n |
...
| `/mbt color <type> <hex>` | Set color |
| `/mbt profile save/load/delete/list` | Profile management |
...
1. Download from [CurseForge](https://www.curseforge.com/wow/addons/midnightbattletext) or [GitHub Releases](https://github.com/SheaGlass/MidnightBattleText/releases/latest)
2. Extract to `World of Warcraft/_retail_/Interface/AddOns/MidnightBattleText`
3. Restart WoW or `/reload`
4. Type `/mbt config` to open the settings editor
